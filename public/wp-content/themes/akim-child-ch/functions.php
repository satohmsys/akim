...
*/
  function theme_enqueue_styles() {
    ...
    wp_enqueue_style( 'child-style', get_stylesheet_directory_uri() . '/style.css', array('parent-style', 'contact'));
  }
 ...
 */
add_action( 'after_setup_theme', 'akim_multilang_ch' );
function akim_multilang_ch(){
